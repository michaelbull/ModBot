...
public final class ColorUtil {
	...
	/**
	 * Creates a new {@link java.awt.Color} with RGB from <code>color</code> and the alpha value  of <code>alpha</code>
	 * @param color {@link java.awt.Color} you want to have with <code>alpha</code>
	 * @param alpha alpha value you want to set. Must be between 0f and 1f
	 * @return new {@link java.awt.Color} with <code>alpha</code>
	 */
